...
var Path = 'path' in params ? params.path : 'PERATURAN-PRESIDEN-112-tahun-2007_133.pdf';
var work = 'wpath' in params ? params.wpath : '../jsv/';
var down = 'down' in params ? params.down : false;
var DEFAULT_URL = Path;
...
var ALLOW_DOWNLOAD = (down === 'true');
PDFJS.imageResourcesPath = '../css/images/';
  PDFJS.workerSrc = work+'pdf.worker.js';
  PDFJS.cMapUrl = '../cmaps/';
