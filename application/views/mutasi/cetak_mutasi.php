...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr>
  ...
  : </span><span
  lang=IT style='font-family:"Arial Narrow","sans-serif"'><?php echo $nama_lengkap;?></span></p>
  </td>
 </tr>
</table>
...
Sehubungan dengan surat permohonan pindah tugas atas nama</span><span lang=SV style='font-family:
...
lang=IT style='font-family:"Arial Narrow","sans-serif"'><?php echo $mutasi['nip'];?></span></p>

<p class=MsoNormal style='text-align:justify'><span lang=SV style='font-family:
"Arial Narrow","sans-serif"'>Tempat dan tanggal lahir            : </span><span
lang=SV style='font-family:"Arial Narrow","sans-serif"'><?php echo ucwords(strtolower($mutasi['tempat_lahir']))	;?>, <?php echo $mutasi['tanggal_lahir'];?>
</span></p>

<p class=MsoNormal style='text-align:justify'><span lang=SV style='font-family:
"Arial Narrow","sans-serif"'>Unit Kerja                                   : </span><span
lang=SV style='font-family:"Arial Narrow","sans-serif"'><?php echo $mutasi['unit_kerja'];?></span></p>
<p class=MsoNormal style='text-align:justify'><span lang=SV style='font-family:
"Arial Narrow","sans-serif"'>Unit Tujuan                                 : </span><span
lang=SV style='font-family:"Arial Narrow","sans-serif"'><?php echo $mutasi['unit_tujuan'];?></span></p>
