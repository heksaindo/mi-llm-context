	                ...
	                <fieldset>
						...
						<div class="widget">
	                    	...
	                    	<div class="well row-fluid">
								...
								<div class="control-group">
	                                <label class="control-label">Penandatangan: <span class="text-error">*</span></label>
	                                <div class="controls">
	                                    <select id="sekretaris" name="sekretaris" class="input-xlarge" data-placeholder="Penandatangan">
										<option value=""></option>
										<?php 
