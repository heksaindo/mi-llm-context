				 ...
				 <div class="widget">
					 <div class="navbar">
						<div class="navbar-inner">
							<h6>Input Tugas Belajar</h6>
						</div>
					</div>
					<form id="form-wizard" class="form-horizontal row-fluid well" method="post" action="<?php echo base_url(); ?>tubel/simpan" >
						<div id="form-wizard-1" class="step">
							...
							<div class="control-group">
								<label class="control-label">Jenis Tubel</label>
								<div class="controls">
									<input id="jenis_tubel" type="text" name="jenis_tubel" value="<?php echo $jenis_tubel;?>" class="input-xlarge" />
								</div>
							</div>
							<div class="control-group">
