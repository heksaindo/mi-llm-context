...
<head>
	...
	function hitung_total_lama(){
		...
		$('#all_total_ak_lama').text(total_All);
	}
					...
					<form id="form-wizard4" class="form-horizontal row-fluid well" method="post" action="" >
						...
						<table cellpadding="4" border="1" style="margin:10px; width:98%;">
							...
							<tr>
								...
								<td colspan="3">
									<input type="text" id="masa_kerja_lama_tahun" name="masa_kerja_lama_tahun" value="<?php echo $data_ak->masa_kerja_lama_tahun;?>" onkeyup="NumberOnly(this)" class="input-small" /> Tahun &nbsp; &nbsp;
									<input type="text" id="masa_kerja_lama_bulan" name="masa_kerja_lama_bulan" value="<?php echo $data_ak->masa_kerja_lama_bulan;?>" onkeyup="NumberOnly(this)" class="input-small" /> Bulan &nbsp; &nbsp;
								</td>
							</tr>
							<tr>
									...
									if ($query2->num_rows() > 0) {
										...
										foreach($query2->result() as $row2){
											...
											<tr>
												...
												<td align="center"><input type="text" class="total_ak_lama" onChange="hitung_total_lama()" name="total_ak_lama[<?php echo $no_A;?>][<?php echo $no_B;?>]" value="<?php echo $total_ak_lama_text; ?>" /></td>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="no_pak" name="no_pak" value="<?php echo $data_ak->no_pak;?>" class="input-xxlarge uppercase" />
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input id="cek_pejabat_penetapan" type="text" name="cek_pejabat_penetapan" value="<?php echo $nama_pejabat_penetapan; ?>" onkeyup="NumberOnly(this)" class="input-xxlarge uppercase is_required" />
