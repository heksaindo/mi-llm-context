...
$(document).ready(function(){
	...
	$("#nama").autocomplete("<?php echo base_url(); ?>pensiun/auto_pegawai/", {
		width: 250,
		minChars:1,
		max:100,
		selectFirst: false,
		    ...
		    <div class="wrapper">
			    ...
			    <?php $this->load->view('layout/_actionwrapper'); ?>
				 ...
				 <div class="widget">
					...
					<form id="form-wizard" class="form-horizontal row-fluid well" method="post" action="<?php echo base_url(); ?>pensiun/insert" >
						<div id="form-wizard-1" class="step">
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<input id="nip" type="text" name="nip" class="input-xlarge" value="" />
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									...
									<input id="golongan" type="hidden" name="golongan" value="" />
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="tmt_pensiun" id="tmt_pensiun" class="input-medium datepicker" value="" />
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">BUP</label>
								<div class="controls">
									<input type="text" name="bup" id="bup" class="input-small" value="" /> ( Tahun )
								</div>
							</div>
						</div>
