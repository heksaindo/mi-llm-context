		...
		<div id="content">
		    ...
		    <div class="wrapper">
				...
				<div>
				 <table>
					<tr>
						<td style="width:150px;"><a href="<?php echo base_url(); ?>cuti/add" class="btn btn-block btn-info">pengajuan cuti</a></td>
						<?php if ($this->session->userdata('login_state') == 'Admin'){ ?>
						<td style="width:150px;"><a href="<?php echo base_url(); ?>cuti/approve" class="btn btn-block btn-info">approve cuti</a></td>
						<?php } ?>
					</tr>
				 </table>
				 </div>
								...
								?>
									<tr>
										...
										<td>
											...
											<?php }else if ($cuti['status_cuti'] == 'submit'){ ?>
											<ul class="table-controls">
												<li><a href="<?php echo base_url(); ?>cuti/edit/<?php echo $cuti_id;?>" class="tip" title="Edit entry"><i class="fam-pencil"></i></a> </li>
