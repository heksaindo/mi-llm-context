		...
		<div id="content">
		    ...
		    <div class="wrapper">
				...
				<div>
				 <table>
					<tr>
						<td style="width:150px;"><a href="<?php echo base_url(); ?>pendidikan/AddDiklatTeknis" class="btn btn-block btn-info">Pengajuan Diklat</a></td>
									...
									<tr>
										...
										<td>
											...
											<ul class="table-controls">
												<li><a onclick="printpage('<?php echo base_url(); ?>Pendidikan/cetak_diklat_teknis/<?php echo $diklat_id;?>');" href="#" class="tip" title="Print entry"><i class="fam-printer"></i></a> </li>
											</ul>
