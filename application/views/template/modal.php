    <div id="help" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="helpLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            <h4>Sign Up</h4>
            <p>Buat akun baru . You can fill the registration form and click submit button to proceed. After have an account, you can use your <code>Username</code> and <code>Password</code> for login.</p><hr/>
            <h4>Login</h4>
            ...
            <!--<div class="media">
            	<a class="pull-left" href="#"><img class="media-object" src="<?php echo base_url('img/download.png');?>" width="64px" height="64px"></a>
            ...
            <div class="media">
                <a class="pull-left" href="#"><img class="media-object" src="<?php echo base_url('img/message.png');?>" width="64px" height="64px"></a>
            ...
            <div class="media">
                <a class="pull-left" href="#"><img class="media-object" src="<?php echo base_url('img/blog.png');?>" width="64px" height="64px"></a>
            ...
            <div class="media">
                <a class="pull-left" href="#"><img class="media-object" src="<?php echo base_url('img/twitter.png');?>" width="64px" height="64px"></a>
