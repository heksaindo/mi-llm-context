...
<script type="text/javascript" src="<?php echo base_url(); ?>js/functions/index.js"></script>
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/charts/FusionCharts.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>js/charts/FusionMaps.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>js/functions/forms.js"></script>