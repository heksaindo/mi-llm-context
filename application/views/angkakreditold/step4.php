		    ...
		    <div class="wrapper">
				...
				<div>
					<form id="form-wizard4" class="form-horizontal row-fluid well" method="post" action="" >
						...
						<table cellpadding="4" border="0" style="margin:10px; width:98%;">
							<tr>
								<td width="170">No Penetapan Angka Kredit</td>
								<td width="5">:</td>
								<td><input type="text" id="no_pak" name="no_pak" value="<?php echo $data_ak->no_pak;?>" style="width:400px;"></td>
							</tr>
							<tr>
								...
								?>
									<input type="text" id="tanggal_pak" name="tanggal_pak" class="input-medium datepicker" value="<?php echo $data_ak->tanggal_pak;?>"/>
								</td>
							</tr>
						</table>	
					</form>							
