	...
	$(document).ready(function(){
		...
		$( "#simpan-kp" ).click(function(){
			...
			if(err == 0){
				$.ajax({
					type: "POST",
					url: "<?php echo base_url(); ?>kenaikanpangkat/update",
					data: $('#form-wizard').serialize(), 
					success: function(msg){	
						if(msg == 'success'){			
							$( "#validasi-kp" ).html( '<font color="blue"> Data sudah disimpan</font>' );						
							window.location.assign("<?php echo base_url().'laporan/kp'; ?>");											
						}else{
			    ...
			    <div class="crumbs">
		            <ul id="breadcrumbs" class="breadcrumb"> 
		                <li><a href="<?php echo base_url(); ?>home">Dashboard</a></li>
						 <li class="active"><a href="<?php echo base_url(); ?>laporan/kp" title="">Rekap Kenaikan Pangkat</a></li>
		            </ul>
				...
				?>
				 ...
				 <div class="widget">
					...
					<form id="form-wizard" class="form-horizontal row-fluid well" method="post" >
						...
						<div id="form-wizard-2" class="step">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input id="pejabatpenetapan" type="text" name="pejabatpenetapan" value="<?php echo $data_kp['pejabat_penandatangan'];?>" class="input-xlarge" />
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">Tanggal SK</label>
								<div class="controls">
									<input id="tanggal_sk" type="text" name="tanggal_sk" value="<?php echo $data_kp['tgl_sk'];?>" class="datepicker input-medium" />
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input id="masa_kerja_gol" type="text" name="masa_kerja_gol" value="<?php echo $data_kp['masa_kerja_golongan'];?>" class="input-xlarge" />
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">TMT</label>
								<div class="controls">
									<input id="tanggal_berlaku" type="text" name="tanggal_berlaku" value="<?php echo $data_kp['tmt_kepangkatan'];?>" class="datepicker input-medium" />
								</div>
							</div>
							<div class="control-group">
									...
									<select id="gol_baru" name="gol_baru" class="input-medium is_required">
										...
										<?php 
											foreach($data_golongan as $row){
												if(trim($row->kode_golongan) == trim($data_kp['golongan'])){
													$selected = "selected";
												}else{
													$selected = "";
												}
					...
					<div class="form-actions">
						<a href="<?php echo base_url().'laporan/kp'; ?>" class="btn btn-primary" title="List"><< Back</a>
