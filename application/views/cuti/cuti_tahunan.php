    ...
    <head>
        ...
        <body>
            ...
            <p style="text-align: center;">
                <strong><span style="text-decoration: underline; letter-spacing: 1.0pt;">SURAT IZIN CUTI TAHUNAN</span></strong>
            </p>
            <p style="text-align: center;">
            ...
            <p>
                <span>
                    1. Diberikan cuti tahunan untuk tahun <?php echo date('Y', strtotime($cuti['tgl_mulai']));?> kepada Pegawai Negeri Sipil :
                </span>
            </p>
                    ...
                    <tr>
                        <td>
                            <span>
                                ...
                                <?php echo $this->local_time_format->fullDate($cuti['tgl_mulai'],'d mmmm yyyy');?> s.d <?php echo $this->local_time_format->fullDate($cuti['tgl_akhir'],'d mmmm yyyy');?> dengan ketentuan sebagai berikut :
                            </span>
                        </td>
                    </tr>
                    <tr>
            ...
            <p>
                <span>
                    2. Demikian surat izin cuti tahunan ini	dibuat untuk dapat dipergunakan sebagaimana mestinya.
                </span>
            </p>
            <p style="text-align: center;">&nbsp;</p>
