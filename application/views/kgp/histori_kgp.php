...
var oTable_kgp;
 ...
 $(function() {
	...
	oTable_kgp = $('table#table-kgp').dataTable( {
		...
		"iDisplayLength": 10,
		"sAjaxSource": "<?php echo base_url(); ?>laporan/ajax_histori_kgp",
		    ...
		    <div class="wrapper">
			    ...
			    <div class="crumbs">
		            <ul id="breadcrumbs" class="breadcrumb"> 
		                <li><a href="<?php echo base_url(); ?>home">Dashboard</a></li>
						 <li class="active"><a href="<?php echo base_url(); ?>laporan/kgp" title="">Histori Kenaikan Gaji</a></li>
		            </ul>
                ...
                <div class="widget">
					...
					<!--<div style="float: right;">
						<a href="<?php echo base_url().'kenaikangajipegawai'; ?>"  class="btn btn-primary"><< List Kenaikan Gaji Pegawai</a>
					</div>
					<div style="clear: both;"></div>
					-->
                	<div class="navbar">
                    	<div class="navbar-inner">
                        	<h6>Histori Kenaikan Gaji Pegawai</h6>
                        </div>
                    </div>
