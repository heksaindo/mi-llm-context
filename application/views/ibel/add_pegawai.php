                    ...
                    $.ajax({
                        ...
                        success: function(msg){	
                            if(msg == 'success'){			
								...
								dt = explode("|",msg);
                                $( "#validasi-list" ).html( '<font color="red">'+dt[1]+'</font>' );	
                            }
                            return false;
                        }
                    });
                    ...
                    <form id="form-wizard" class="form-horizontal row-fluid well" method="post" >
                        <div id="form-wizard-1" class="step">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input id="pangkat" type="text" name="pangkat" placeholder="Pangkat - Golongan" class="input-xlarge" value="" />
								</div>
							</div>
							<div class="control-group">
